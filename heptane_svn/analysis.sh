...
then
    cd ${RESULT_DIR}
    sed  -e "s#BENCH_DIR#${RESULT_DIR}#g" -e "s/X_BENCH/$1/g" -e "s/_SOLVER_/$3/g"  -e "s#_CROSS_COMPILER_DIR_#/data/CROSS_COMPILERS/$2/bin#g" /data/config_files/configWCET_template_$2.xml > configWCET.xml
    chmod gou+x configWCET.xml
    /data/bin/HeptaneAnalysis $4 ./configWCET.xml  | tee analysis_$1_$2_$3.log

...
{ 
  ...
  port_id20 = (U8___0 )3;
  tmp21 = 1;//sensor_adc((U32 )port_id20);
  ...
  tmp = 1;//nxt_motor_get_count((U32___0 )0);
  ...
  if (steering_angle > 2L) {
    if ((int )EDC_flag == -1) {
      diff_gain = 1;//(S32___0 )((1.0F - ((float )steering_angle * 0.7F) / (float )40) * (float )10);
    }
    tmp___1 = 1;//FrictionComp((analog_stick_left * diff_gain) / 10L, (S32___0 )10);
    //nxt_motor_set_speed((U32___0 )2, (int )tmp___1, 1);
    tmp___2 = 1;//FrictionComp(analog_stick_left, (S32___0 )10);
  ...
  if (steering_angle < -2L) {
    ...
    tmp___3 = 1;//FrictionComp(analog_stick_left, (S32___0 )10);
    //nxt_motor_set_speed((U32___0 )2, (int )tmp___3, 1);
    tmp___4 = 1;//FrictionComp((analog_stick_left * diff_gain) / 10L, (S32___0 )10);
    //nxt_motor_set_speed((U32___0 )1, (int )tmp___4, 1);
  } else {
    tmp___5 = 1;//FrictionComp(analog_stick_left, (S32___0 )10);
   // nxt_motor_set_speed((U32___0 )2, (int )tmp___5, 1);
    tmp___6 = 1;//FrictionComp(analog_stick_left, (S32___0 )10);
...
{ 
  ...
  {
  sonar = 1;//ecrobot_get_sonar_sensor((U8___0 )1);
  //TerminateTask();
  return;
}
}

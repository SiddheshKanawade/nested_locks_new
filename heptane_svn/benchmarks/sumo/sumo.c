...
{ 
  ...
  while (port_id9 < 4) {
  ANNOT_MAXITER(4);
    sd10 = 1;& sensor_data[port_id9];
    if (sd10)//{(sd10->port_in_use) {
      mode11 = 1;//(U8___1 )sd10->mode;
      if ((int )mode11 == 6) {
        //sd10->port_in_use = (U8___1 volatile   )0;
        //colorsensor_init(port_id9, (unsigned char)136);
        goto Lret_ecrobot_process_bg_nxtcolorsensor;
      } else
      if ((int )mode11 != sd10){//((int )mode11 != (int )sd10->mode_state) 
	{
      ...
      if ((int )mode11 == 0) {
        tmp12 = 1;//colorsensor_color_get(port_id9);
       // sd10->color = (U16___1 )tmp12;
        //colorsensor_rgb_get(port_id9, sd10->rgb);
      } else {
        tmp___013 = 1;//colorsensor_light_get(port_id9);
...
{ 
  ...
  duration = 3000;
  port_id40 = (U8___3 )1;
  tmp41 = 1;//i2c_busy((int )port_id40);
  if (tmp41 == 0) {
  ...
  if (distance > 70L) {
    if (SeekStarted == 0UL) {
      SeekStarted = 1;//systick_get_ms();
      tmp___0 = 1;//rand();
      tmp___1 = 1;//copysign(1, tmp___0 - 1073741823);
      modifier = tmp___1;
...
*/
  ...
  while (str36){//(*str36) {
  ANNOT_MAXITER(5);
    if (str36 != 10){//((int const   )*str36 != 10) {
  ...
  while (str37){//(*str37) {
  ANNOT_MAXITER(4);
    if (str37 != 10){// ((int const   )*str37 != 10) {
  ...
  while (str38){//(*str38) {
  ANNOT_MAXITER(4);
    if (str38 != 10){//((int const   )*str38 != 10) {
  ...
  while (str39){//(*str39) {
  ANNOT_MAXITER(6);
    if (str39 != 10){//((int const   )*str39 != 10) {
  ...
  while (str40){//(*str40) {
  ANNOT_MAXITER(5);
    if (str40 != 10){//((int const   )*str40 != 10) {
  ...
  while (str41){//(*str41) {
  ANNOT_MAXITER(4);
    if (str41 != 10){//((int const   )*str41 != 10) {
  ...
  while (str42){//(*str42) {
ANNOT_MAXITER(10);
    if (str42 != 10){//((int const   )*str42 != 10) {
  ...
  while (str43){// (*str43) {
  ANNOT_MAXITER(1);
    if (str43 != 10){//((int const   )*str43 != 10) {
  ...
  while (str44){// (*str44) {
  ANNOT_MAXITER(9);
    if (str44 != 10){//((int const   )*str44 != 10) {
  ...
  while (str45){//(*str45) {
  ANNOT_MAXITER(6);
    if (str45 != 10){//((int const   )*str45 != 10) {
  ...
  while (str46){//(*str46) {
  ANNOT_MAXITER(5);
    if (str46 != 10){//((int const   )*str46 != 10) {
  ...
  while(str47){// (*str47) {
   ANNOT_MAXITER(5);
    if (str47 != 10){//((int const   )*str47 != 10) {
  ...
  while(str48){// (*str48) {
   ANNOT_MAXITER(1);
    if(str48 != 10){// ((int const   )*str48 != 10) {
...
void TaskMainColorSensorTask_blk1(){
  U16___3 color ;
  U16___3 tmp ;
  int priority3 ;
  int speed_left4 ;
...
void TaskMainColorSensorTask_blk2(){
  U16___3 color ;
  U16___3 tmp ;
  int priority3 ;
  int speed_left4 ;
...
void TaskMainSonarSensorTask_blk1(){
  int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk2(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk3(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk4(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk5(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk6(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk7(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
void TaskMainSonarSensorTask_blk8(){
int duration ;
  S32___1 distance ;
  S32___1 tmp ;
  int seek_delay_1 ;
...
{ 
  ...
  //TaskMainDisplayTask();
  //TaskMainColorSensorTask();
  //TaskMainSonarSensorTask();
  //TaskMainMotorcontrolTask();
  

  //TaskMainMotorcontrolTask_blk();
  //TaskMainColorSensorTask_blk1();
  //TaskMainColorSensorTask_blk2();
  //TaskMainDisplayTask_blk();
  //TaskMainSonarSensorTask_blk1();
  //TaskMainSonarSensorTask_blk2();
  //TaskMainSonarSensorTask_blk3();
  //TaskMainSonarSensorTask_blk4();
  //TaskMainSonarSensorTask_blk5();
  //TaskMainSonarSensorTask_blk6();
  //TaskMainSonarSensorTask_blk7();
  TaskMainSonarSensorTask_blk8();

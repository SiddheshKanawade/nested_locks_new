...
in
  Printf.printf "\n Low %f, High %f" (wrt low low.wcet !task_response_time) (float_of_int(high.periodicity)) ;
...
let maindb (f : file) =
  ...
  E.log "\n--- Conflicting Function pairs --- %d" (length conflictFunPair);

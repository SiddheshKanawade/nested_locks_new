...
void nxt_motor_command(unsigned long n, int cmd, int target_count,
                       int speed_percent);
...
extern __attribute__((__nothrow__)) void *(__attribute__((
    __nonnull__(1), __leaf__)) memset)(void *__s, int __c, unsigned long __n);
...
void display_bitmap_copy(unsigned char const *data, unsigned long width,
                         unsigned long depth, unsigned long x, unsigned long y);
          ...
          if (n28 < 3UL) {
            ...
            if (brake30) {
              io_to_avr.output_mode =
                  (U8)((int)io_to_avr.output_mode | (1 << n28));
            } else {
              io_to_avr.output_mode =
                  (U8)((int)io_to_avr.output_mode & ~(1 << n28));
            }
      ...
      }
      {
        ...
        brake33 = brake27;
        {
          if (n31 < 3UL) {
            ...
            if (brake33) {
              io_to_avr.output_mode =
                  (U8)((int)io_to_avr.output_mode | (1 << n31));
            } else {
              io_to_avr.output_mode =
                  (U8)((int)io_to_avr.output_mode & ~(1 << n31));
            }
...
void main(void) {
  ...
  create_task('TaskMainAcquisitionTask', 'TaskMainAcquisitionTask', 3, 30,
              0.026);

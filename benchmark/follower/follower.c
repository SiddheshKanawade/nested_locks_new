...
{ 
  ...
  if ((int )buf == 1) {
    n5 = (U32___4 )1;
    speed_percent6 = - right;
    brake7 = 1;
    if (n5 < 3UL) {
      if (speed_percent6 > 100) {
        speed_percent6 = 100;
      }
      if (speed_percent6 < -100) {
        speed_percent6 = -100;
      }
      motor[n5].speed_percent = speed_percent6;
      n17 = n5;
      power_percent18 = speed_percent6;
      brake19 = brake7;
      if (n17 < 3UL) {
    ...
    if (n8 < 3UL) {
      ...
      n20 = n8;
      power_percent21 = speed_percent9;
      brake22 = brake10;
      if (n20 < 3UL) {
        io_to_avr.output_percent[n20] = (S8___0 )power_percent21;
        if (brake22) {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode | (1 << n20));
        } else {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode & ~ (1 << n20));
        }
      }
  ...
  if ((int )buf == 2) {
    ...
    if (n11 < 3UL) {
      ...
      n23 = n11;
      power_percent24 = speed_percent12;
      brake25 = brake13;
      if (n23 < 3UL) {
        io_to_avr.output_percent[n23] = (S8___0 )power_percent24;
        if (brake25) {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode | (1 << n23));
        } else {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode & ~ (1 << n23));
        }
      }
    ...
    Lret_nxt_motor_set_speed___1: 
    n14 = (U32___4 )2;
    speed_percent15 = left;
    brake16 = 1;
    if (n14 < 3UL) {
      if (speed_percent15 > 100) {
        speed_percent15 = 100;
      }
      if (speed_percent15 < -100) {
        speed_percent15 = -100;
      }
      motor[n14].speed_percent = speed_percent15;
      n26 = n14;
      power_percent27 = speed_percent15;
      brake28 = brake16;
      if (n26 < 3UL) {
        io_to_avr.output_percent[n26] = (S8___0 )power_percent27;
        if (brake28) {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode | (1 << n26));
        } else {
          io_to_avr.output_mode = (U8___1 )((int )io_to_avr.output_mode & ~ (1 << n26));
        }
      }

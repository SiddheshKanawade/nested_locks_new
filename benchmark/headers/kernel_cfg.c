...
KERNEL_CFG.C FOR 2 PERIODIC TASKS AND A SEMAPHORE
- THE PRIORITY QUICK TASK MUST BE CALLED HighTask (IN THE GLUE CODE)
- THE NON-PRIORITY SLOW TASK MUST BE CALLED LowTask (IN THE GLUE CODE)
- PERIODS ARE TO BE INFORMED IN periodes.h
- A SINGLE SEMAPHORE IS PROVIDED IN THIS CORE
  * IT IS NECESSARY TO PROTECT THE INTEGRITY OF ACCESS TO THE SCREEN,
    WHERE HIS NAME "lcd".
  * WE CAN OF COURSE USE IT TO REALIZE THE EXCLUSION
    OF ANY BIT OF CODE, BUT IT IS BAD PRACTICE!
    (see the course on herminist programming)
*/
...
/**** HERE: the fast and slow periods, given in ms
*/
const TickType alminib_cycle[TNUM_ALARM] = {
HIGH_PERIOD, /* QUICK PERIOD */
LOW_PERIOD,  /* PERIOD SPRING */
};
...
/*
HERE WE FORCE THE CALL OF EXTERNAL INITS
*/

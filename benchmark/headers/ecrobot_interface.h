...
extern  U16 ecrobot_get_light_sensor(U32 port_id);
extern void ecrobot_set_light_sensor_active(U32 port_id);
extern void ecrobot_set_light_sensor_inactive(U32 port_id);
